...
pub async fn create_shop(configuration: &configuration::Configuration, x_authorization: &str, x_wallet_decrypt_key: &str, create_shop_request: crate::models::CreateShopRequest) -> Result<crate::models::CreateShop200Response, Error<CreateShopError>> {
...
pub async fn remove_shop_offer(configuration: &configuration::Configuration, shop_id: &str, shop_offer_id: &str, x_authorization: &str, x_wallet_decrypt_key: &str) -> Result<crate::models::TransactionModel, Error<RemoveShopOfferError>> {
    let local_var_configuration = configuration;
...
pub async fn set_shop_offer(configuration: &configuration::Configuration, shop_id: &str, x_authorization: &str, x_wallet_decrypt_key: &str, set_shop_offer_request: crate::models::SetShopOfferRequest) -> Result<crate::models::TransactionModel, Error<SetShopOfferError>> {
    let local_var_configuration = configuration;
...
pub async fn use_shop_offer(configuration: &configuration::Configuration, shop_id: &str, shop_offer_id: &str, x_authorization: &str, x_wallet_decrypt_key: &str) -> Result<crate::models::TransactionModel, Error<UseShopOfferError>> {
    let local_var_configuration = configuration;
...
pub async fn withdraw_from_shop(configuration: &configuration::Configuration, shop_id: &str, x_authorization: &str, x_wallet_decrypt_key: &str, withdraw_from_shop_request: crate::models::WithdrawFromShopRequest) -> Result<crate::models::TransactionModel, Error<WithdrawFromShopError>> {
    let local_var_configuration = configuration;
