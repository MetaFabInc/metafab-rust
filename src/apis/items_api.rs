...
pub async fn batch_mint_collection_items(configuration: &configuration::Configuration, collection_id: &str, x_authorization: &str, x_wallet_decrypt_key: &str, batch_mint_collection_items_request: crate::models::BatchMintCollectionItemsRequest) -> Result<crate::models::TransactionModel, Error<BatchMintCollectionItemsError>> {
...
pub async fn batch_transfer_collection_items(configuration: &configuration::Configuration, collection_id: &str, x_authorization: &str, x_wallet_decrypt_key: &str, batch_transfer_collection_items_request: crate::models::BatchTransferCollectionItemsRequest) -> Result<crate::models::TransactionModel, Error<BatchTransferCollectionItemsError>> {
    let local_var_configuration = configuration;
...
pub async fn burn_collection_item(configuration: &configuration::Configuration, collection_id: &str, collection_item_id: f32, x_authorization: &str, x_wallet_decrypt_key: &str, burn_collection_item_request: crate::models::BurnCollectionItemRequest) -> Result<crate::models::TransactionModel, Error<BurnCollectionItemError>> {
    let local_var_configuration = configuration;
...
pub async fn create_collection(configuration: &configuration::Configuration, x_authorization: &str, x_wallet_decrypt_key: &str, create_collection_request: crate::models::CreateCollectionRequest) -> Result<crate::models::CreateCollection200Response, Error<CreateCollectionError>> {
    let local_var_configuration = configuration;
...
pub async fn create_collection_item(configuration: &configuration::Configuration, collection_id: &str, x_authorization: &str, x_wallet_decrypt_key: &str, create_collection_item_request: crate::models::CreateCollectionItemRequest) -> Result<crate::models::TransactionModel, Error<CreateCollectionItemError>> {
    let local_var_configuration = configuration;
...
pub async fn get_collection_item(configuration: &configuration::Configuration, collection_id: &str, collection_item_id: f32) -> Result<crate::models::CollectionItem, Error<GetCollectionItemError>> {
    let local_var_configuration = configuration;
...
pub async fn get_collection_items(configuration: &configuration::Configuration, collection_id: &str) -> Result<Vec<crate::models::CollectionItem>, Error<GetCollectionItemsError>> {
    let local_var_configuration = configuration;
...
pub async fn grant_collection_role(configuration: &configuration::Configuration, collection_id: &str, x_authorization: &str, x_wallet_decrypt_key: &str, grant_collection_role_request: crate::models::GrantCollectionRoleRequest) -> Result<crate::models::TransactionModel, Error<GrantCollectionRoleError>> {
    let local_var_configuration = configuration;
...
pub async fn mint_collection_item(configuration: &configuration::Configuration, collection_id: &str, collection_item_id: f32, x_authorization: &str, x_wallet_decrypt_key: &str, mint_collection_item_request: crate::models::MintCollectionItemRequest) -> Result<crate::models::TransactionModel, Error<MintCollectionItemError>> {
    let local_var_configuration = configuration;
...
pub async fn revoke_collection_role(configuration: &configuration::Configuration, collection_id: &str, x_authorization: &str, x_wallet_decrypt_key: &str, revoke_collection_role_request: crate::models::RevokeCollectionRoleRequest) -> Result<crate::models::TransactionModel, Error<RevokeCollectionRoleError>> {
    let local_var_configuration = configuration;
...
pub async fn set_collection_approval(configuration: &configuration::Configuration, collection_id: &str, x_authorization: &str, x_wallet_decrypt_key: &str, set_collection_approval_request: crate::models::SetCollectionApprovalRequest) -> Result<crate::models::TransactionModel, Error<SetCollectionApprovalError>> {
    let local_var_configuration = configuration;
...
pub async fn set_collection_item_timelock(configuration: &configuration::Configuration, collection_id: &str, collection_item_id: f32, x_authorization: &str, x_wallet_decrypt_key: &str, set_collection_item_timelock_request: crate::models::SetCollectionItemTimelockRequest) -> Result<crate::models::TransactionModel, Error<SetCollectionItemTimelockError>> {
    let local_var_configuration = configuration;
...
pub async fn transfer_collection_item(configuration: &configuration::Configuration, collection_id: &str, collection_item_id: f32, x_authorization: &str, x_wallet_decrypt_key: &str, transfer_collection_item_request: crate::models::TransferCollectionItemRequest) -> Result<crate::models::TransactionModel, Error<TransferCollectionItemError>> {
    let local_var_configuration = configuration;
