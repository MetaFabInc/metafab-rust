...
pub async fn create_lootbox_manager(configuration: &configuration::Configuration, x_authorization: &str, x_wallet_decrypt_key: &str, create_lootbox_manager_request: crate::models::CreateLootboxManagerRequest) -> Result<crate::models::CreateLootboxManager200Response, Error<CreateLootboxManagerError>> {
...
pub async fn open_lootbox_manager_lootbox(configuration: &configuration::Configuration, lootbox_manager_id: &str, lootbox_manager_lootbox_id: &str, x_authorization: &str, x_wallet_decrypt_key: &str) -> Result<Vec<crate::models::TransactionModel>, Error<OpenLootboxManagerLootboxError>> {
    let local_var_configuration = configuration;
...
pub async fn remove_lootbox_manager_lootbox(configuration: &configuration::Configuration, lootbox_manager_id: &str, lootbox_manager_lootbox_id: &str, x_authorization: &str, x_wallet_decrypt_key: &str) -> Result<crate::models::TransactionModel, Error<RemoveLootboxManagerLootboxError>> {
    let local_var_configuration = configuration;
...
pub async fn set_lootbox_manager_lootbox(configuration: &configuration::Configuration, lootbox_manager_id: &str, x_authorization: &str, x_wallet_decrypt_key: &str, set_lootbox_manager_lootbox_request: crate::models::SetLootboxManagerLootboxRequest) -> Result<crate::models::TransactionModel, Error<SetLootboxManagerLootboxError>> {
    let local_var_configuration = configuration;
