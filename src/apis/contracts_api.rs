...
pub async fn transfer_contract_ownership(configuration: &configuration::Configuration, contract_id: &str, x_authorization: &str, x_wallet_decrypt_key: &str, transfer_contract_ownership_request: crate::models::TransferContractOwnershipRequest) -> Result<crate::models::TransactionModel, Error<TransferContractOwnershipError>> {
    let local_var_configuration = configuration;
...
pub async fn write_contract(configuration: &configuration::Configuration, contract_id: &str, x_authorization: &str, x_wallet_decrypt_key: &str, write_contract_request: crate::models::WriteContractRequest) -> Result<crate::models::TransactionModel, Error<WriteContractError>> {
    let local_var_configuration = configuration;
