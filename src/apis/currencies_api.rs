...
pub async fn grant_currency_role(configuration: &configuration::Configuration, currency_id: &str, x_authorization: &str, x_password: &str, grant_currency_role_request: crate::models::GrantCurrencyRoleRequest) -> Result<crate::models::TransactionModel, Error<GrantCurrencyRoleError>> {
    let local_var_configuration = configuration;
...
pub async fn revoke_currency_role(configuration: &configuration::Configuration, currency_id: &str, x_authorization: &str, x_password: &str, revoke_collection_role_request: crate::models::RevokeCollectionRoleRequest) -> Result<crate::models::TransactionModel, Error<RevokeCurrencyRoleError>> {
    let local_var_configuration = configuration;
