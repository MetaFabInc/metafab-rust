...
/// struct for typed errors of method [`get_currency_role`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetCurrencyRoleError {
    Status400(String),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`grant_currency_role`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GrantCurrencyRoleError {
    Status400(String),
    Status401(String),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`revoke_currency_role`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RevokeCurrencyRoleError {
    Status400(String),
    Status401(String),
    UnknownValue(serde_json::Value),
}
...
pub async fn batch_transfer_currency(configuration: &configuration::Configuration, currency_id: &str, x_authorization: &str, x_wallet_decrypt_key: &str, batch_transfer_currency_request: crate::models::BatchTransferCurrencyRequest) -> Result<crate::models::TransactionModel, Error<BatchTransferCurrencyError>> {
...
pub async fn burn_currency(configuration: &configuration::Configuration, currency_id: &str, x_authorization: &str, x_wallet_decrypt_key: &str, burn_currency_request: crate::models::BurnCurrencyRequest) -> Result<crate::models::TransactionModel, Error<BurnCurrencyError>> {
    let local_var_configuration = configuration;
...
pub async fn create_currency(configuration: &configuration::Configuration, x_authorization: &str, x_wallet_decrypt_key: &str, create_currency_request: crate::models::CreateCurrencyRequest) -> Result<crate::models::CreateCurrency200Response, Error<CreateCurrencyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_currency_role(configuration: &configuration::Configuration, currency_id: &str, role: &str, address: Option<&str>, wallet_id: Option<&str>) -> Result<bool, Error<GetCurrencyRoleError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/currencies/{currencyId}/roles", local_var_configuration.base_path, currencyId=crate::apis::urlencode(currency_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetCurrencyRoleError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn grant_currency_role(configuration: &configuration::Configuration, currency_id: &str, x_authorization: &str, x_wallet_decrypt_key: &str, grant_currency_role_request: crate::models::GrantCurrencyRoleRequest) -> Result<crate::models::TransactionModel, Error<GrantCurrencyRoleError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.header("X-Authorization", x_authorization.to_string());
    local_var_req_builder = local_var_req_builder.header("X-Wallet-Decrypt-Key", x_wallet_decrypt_key.to_string());
    local_var_req_builder = local_var_req_builder.json(&grant_currency_role_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GrantCurrencyRoleError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn mint_currency(configuration: &configuration::Configuration, currency_id: &str, x_authorization: &str, x_wallet_decrypt_key: &str, mint_currency_request: crate::models::MintCurrencyRequest) -> Result<crate::models::TransactionModel, Error<MintCurrencyError>> {
    let local_var_configuration = configuration;
...
pub async fn revoke_currency_role(configuration: &configuration::Configuration, currency_id: &str, x_authorization: &str, x_wallet_decrypt_key: &str, revoke_collection_role_request: crate::models::RevokeCollectionRoleRequest) -> Result<crate::models::TransactionModel, Error<RevokeCurrencyRoleError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RevokeCurrencyRoleError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn set_currency_fees(configuration: &configuration::Configuration, currency_id: &str, x_authorization: &str, x_wallet_decrypt_key: &str, set_currency_fees_request: crate::models::SetCurrencyFeesRequest) -> Result<crate::models::TransactionModel, Error<SetCurrencyFeesError>> {
    let local_var_configuration = configuration;
...
pub async fn transfer_currency(configuration: &configuration::Configuration, currency_id: &str, x_authorization: &str, x_wallet_decrypt_key: &str, transfer_currency_request: crate::models::TransferCurrencyRequest) -> Result<crate::models::TransactionModel, Error<TransferCurrencyError>> {
    let local_var_configuration = configuration;
