...
pub async fn get_collection_approval(configuration: &configuration::Configuration, collection_id: &str, operator_address: &str, address: Option<&str>, wallet_id: Option<&str>) -> Result<f32, Error<GetCollectionApprovalError>> {
    let local_var_configuration = configuration;
...
pub async fn get_collection_item(configuration: &configuration::Configuration, collection_id: &str, collection_item_id: f32) -> Result<Vec<serde_json::Value>, Error<GetCollectionItemError>> {
    let local_var_configuration = configuration;
...
pub async fn get_collection_item_balance(configuration: &configuration::Configuration, collection_id: &str, collection_item_id: f32, address: Option<&str>, wallet_id: Option<&str>) -> Result<f32, Error<GetCollectionItemBalanceError>> {
    let local_var_configuration = configuration;
...
pub async fn get_collection_item_balances(configuration: &configuration::Configuration, collection_id: &str, address: Option<&str>, wallet_id: Option<&str>) -> Result<::std::collections::HashMap<String, f32>, Error<GetCollectionItemBalancesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_collection_item_supplies(configuration: &configuration::Configuration, collection_id: &str) -> Result<::std::collections::HashMap<String, f32>, Error<GetCollectionItemSuppliesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_collection_item_supply(configuration: &configuration::Configuration, collection_id: &str, collection_item_id: f32, address: Option<&str>, wallet_id: Option<&str>) -> Result<f32, Error<GetCollectionItemSupplyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_collection_item_timelock(configuration: &configuration::Configuration, collection_id: &str, collection_item_id: f32) -> Result<f32, Error<GetCollectionItemTimelockError>> {
    let local_var_configuration = configuration;
